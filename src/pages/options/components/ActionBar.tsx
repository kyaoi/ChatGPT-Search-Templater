...
export function ActionBar({
  ...
  return (
    <div className="w-full max-w-full overflow-hidden rounded-[26px] border border-[rgba(148,163,184,0.25)] bg-[rgba(255,255,255,0.7)] px-7 py-[22px] backdrop-blur-[18px] shadow-[0_25px_50px_-30px_rgba(15,23,42,0.4)] ">
      <div className="mb-4">
